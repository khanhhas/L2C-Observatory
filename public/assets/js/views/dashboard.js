...
console.log("ĐÃ TẢI CODE MỚI: BẢN ĐỒ VỆ TINH + HSDC NOWCASTING (CHUẨN HÓA DỮ LIỆU ĐO MƯA)"); 
...
export const DashboardView = {
                ...
                <div class="glass-panel p-4 h-100">
                    ...
                    <div class="d-flex justify-content-between border-top border-secondary pt-3">
                     ...
                     <div class="d-flex justify-content-between mt-2">
                        ...
                        <strong class="text-warning" id="hw-mount">ĐANG ĐỌC...</strong>
                    </div>
                    <div class="d-flex justify-content-between mt-2">
    ...
    initMap: function() {
        ...
        const radarOverlays = {
            "Ảnh Radar (OpenMeteo)": this.radarLayerGroup,
    ...
    update: function(sysData, diagData) {
        ...
        if (alarmStatus) {
            // [ĐÃ SỬA LỖI]: Mạch Alarm chỉ nhận ESP-NOW thụ động, không gửi Heartbeat cho Mái.
            // Do đó sysData.roof.AlarmConnected sẽ luôn false. Ta chuyển sang dùng diagData.alarm_uptime từ API Health do cron.php thu thập.
        ...
        if (radarContainer) {
            ...
            if (sysData && sysData.RadarAI) {
                ...
                if (this.customMap && rData.rainviewer_path) {
                    ...
                    if (rData.cells && rData.cells.length > 0) {
